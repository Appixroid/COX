...
public class XMLCommentStringifier implements ParametrableXMLStringifier
{
	private XMLElement element;
	private Collection<XMLOutputOptions> options;

	public XMLCommentStringifier(XMLElement element, Collection<XMLOutputOptions> options)
	{
	...
	{
		return this.getIndentation(depth) + "<!--" + this.element.getValue() + "-->";
	}
}
